...
CREATE TABLE `executor` (
  ...
  `surname` varchar(20) NOT NULL COMMENT 'С„Р°РјРёР»РёСЏ',
  `name` varchar(20) NOT NULL COMMENT 'РёРјСЏ',
  `middle_name` varchar(20) NOT NULL COMMENT 'РѕС‚С‡РµСЃС‚РІРѕ',
  PRIMARY KEY (`id_executor`)
) ENGINE=InnoDB AUTO_INCREMENT=97 DEFAULT CHARSET=utf8 COMMENT='РРјРµРЅСЏ СЂР°Р±РѕС‚РЅРёРєРѕРІ';
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='РљРѕР»Р»РµРєС†РёСЏ СЃС‚Р°С‚СѓСЃРѕРІ Р·Р°РґР°РЅРёСЏ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='Р—Р°РґР°РЅРёСЏ, РёСЃРїРѕР»РЅРёС‚РµР»Рё, СЃСЂРѕРєРё';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `to_do` VALUES (1,'Задача №2',1,2,'2020-05-25 05:50:18','0000-00-00'),(2,'Задача №1',2,1,'2020-05-25 15:42:32','0000-00-00'),(34,'Задача №3',5,94,'2020-05-27 16:19:44','0000-00-00'),(35,'Задача №4',4,95,'2020-05-27 16:19:58','0000-00-00'),(36,'Задача №5',3,96,'2020-05-27 16:20:07','0000-00-00');
...
-- Dump completed on 2020-05-27 20:48:04
